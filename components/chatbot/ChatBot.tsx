      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 left-4 right-4 sm:left-6 sm:right-auto z-50 w-auto sm:w-96 h-[500px] max-h-[calc(100dvh-140px)] bg-alabaster dark:bg-[#231B12] rounded-2xl shadow-2xl border border-gold-200 dark:border-white/10 flex flex-col overflow-hidden"
          >
              ...
              <div className="flex-1 flex items-center justify-center p-6">
                <div className="w-full space-y-4">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-border dark:border-white/10 bg-alabaster dark:bg-[#2E2519] px-4 py-2.5 text-sm text-foreground dark:text-white placeholder:text-muted-foreground focus:outline-none focus:border-gold-500"
                    autoFocus
                  />
              ...
              <div className="p-3 border-t border-gold-200 dark:border-white/10">
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 rounded-xl border border-gold-200 dark:border-white/10 bg-alabaster dark:bg-[#2E2519] px-3 py-3 min-h-[44px] text-sm text-vedara-900 dark:text-white placeholder:text-charcoal/50 dark:placeholder:text-white/30 focus:outline-none focus:border-gold-500 dark:focus:border-gold-500"
                  />
                  <button
                    onClick={handleSend}
