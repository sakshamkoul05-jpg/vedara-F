  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 right-6 z-40 w-14 h-14 rounded-full bg-forest-600 text-cream-50 shadow-lg hover:bg-forest-700 transition-all hover:scale-105 flex items-center justify-center"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-40 w-80 sm:w-96 h-[500px] bg-cream-50 dark:bg-earth-800 rounded-2xl shadow-2xl border border-earth-200 dark:border-earth-700 flex flex-col overflow-hidden"
          >
            <div className="bg-forest-600 p-4 flex items-center justify-between">
              ...
              <button onClick={() => setIsOpen(false)} className="text-cream-100 hover:text-cream-50">
                <X className="w-5 h-5" />
              </button>
            </div>
