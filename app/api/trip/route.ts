...
function generateSmartItinerary(params: TripParams) {
  ...
  if (days === 1) {
    itinerary.push({
      ...
      activities: [
        ...
        { time: '7:00 PM', activity: 'Candlelit dinner at Café Charade', icon: 'Coffee', location: 'Café Charade' },
      ],
    });
  } else if (days === 2) {
    itinerary.push({
    ...
    itinerary.push({
      ...
      activities: [
        ...
        { time: '9:00 AM', activity: 'Breakfast at Café Charade', icon: 'Coffee', location: 'Café Charade' },
    ...
    itinerary.push({
      ...
      activities: [
        ...
        { time: '5:30 PM', activity: 'Golden hour coffee at Café Charade', icon: 'Coffee', location: 'Café Charade' },
    ...
    itinerary.push({
      ...
      activities: [
        ...
        { time: '9:00 AM', activity: 'Breakfast & packing', icon: 'Coffee', location: 'Café Charade' },
    ...
    itinerary.push({
      ...
      activities: [
        ...
        { time: '5:30 PM', activity: 'Sunset tea at Café Charade', icon: 'Coffee', location: 'Café Charade' },
    ...
    itinerary.push({
      ...
      activities: [
        { time: '7:30 AM', activity: 'Hearty mountain breakfast', icon: 'Coffee', location: 'Café Charade' },
    ...
    itinerary.push({
      ...
      activities: [
        { time: '7:30 AM', activity: 'Breakfast & pack day bag', icon: 'Coffee', location: 'Café Charade' },
    ...
    if (days >= 4) {
      itinerary.push({
        ...
        activities: [
          ...
          { time: '8:30 AM', activity: 'Final breakfast at Café Charade', icon: 'Coffee', location: 'Café Charade' },
    ...
    if (days >= 5) {
      itinerary.push({
        ...
        activities: [
          { time: '6:00 AM', activity: 'Early breakfast', icon: 'Coffee', location: 'Café Charade' },
          ...
          { time: '2:00 PM', activity: 'Lunch at Café Charade', icon: 'Coffee', location: 'Café Charade' },
          { time: '4:00 PM', activity: 'Kids Zone activities', icon: 'Users', location: 'The Vedara' },
          { time: '8:00 PM', activity: 'Farewell dinner', icon: 'Coffee', location: 'Café Charade' },
        ],
      });
    }
  }
  ...
  return {
    ...
    tips: [
      ...
      'Try the Himalayan Cold Coffee at Café Charade — a guest favourite!',
