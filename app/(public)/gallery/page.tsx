...
const galleryItems = [
  ...
  { id: 2, category: 'cafe', caption: 'The Forest Pantry at golden hour', image: 'https://images.unsplash.com/photo-1414235077428-338989a2e8c0?w=800&q=80', span: 'row-span-2', alt: 'The Perch dining area bathed in warm golden hour sunlight' },
  ...
  { id: 5, category: 'cafe', caption: 'Hand-poured coffee ceremony', image: 'https://images.unsplash.com/photo-1495474472287-4d71bcdd2085?w=800&q=80', span: 'row-span-1', alt: 'Barista preparing hand-poured artisan coffee at The Perch' },
  ...
  { id: 8, category: 'cafe', caption: 'Wood-fired hearth kitchen', image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=800&q=80', span: 'row-span-1', alt: 'Wood-fired kitchen at The Perch preparing fresh meals' },
...
export default function GalleryPage() {
  ...
  return (
    <>
      <section className="pt-32 pb-20 bg-alabaster dark:bg-[#140D07]">
      ...
      <section className="pb-20 dark:bg-[#140D07]">
        <div className="vintage-container">
          <ScrollReveal>
                ...
                <motion.button
                  ...
                  className={`px-5 py-2.5 rounded-full text-sm font-medium capitalize transition-all whitespace-nowrap ${
                    filter === cat
                      ...
                      : 'bg-gold-50 dark:bg-[#2E2519] text-charcoal/70 dark:text-[#B8A385] hover:bg-gold-100 dark:hover:bg-[#2E2519]/80'
                  }`}
                  whileTap={{ scale: 0.95 }}
                  layout
                >
              ...
              {filtered.map((item, i) => (
                <ScrollReveal key={item.id} delay={i * 0.03}>
                  <motion.button
                    ...
                    className="group relative w-full rounded-xl overflow-hidden bg-gold-100 dark:bg-[#2E2519] break-inside-avoid"
