...
const FALLBACK_COTTAGES: Record<string, Cottage> = {
  ...
  'magpie-retreat': { id: '3', slug: 'magpie-retreat', name: 'Magpie Retreat', description: 'Intimate Mountain View Suite — a sanctuary for couples and solo seekers, with a plush king-size bed and a private panoramic balcony.', shortDesc: 'Intimate Mountain View Suite — where serenity meets soul', category: 'Intimate Mountain View Suite', pricePerNight: 4500, heaterCharge: 600, capacity: 3, bedrooms: 1, bathrooms: 1, size: 270, amenities: ['wifi', 'fireplace', 'mountain view', 'balcony'], images: [], isActive: true, sortOrder: 3 },
  'whistling-thrush': { id: '4', slug: 'whistling-thrush', name: 'Whistling Thrush', description: 'Charming duplex with a deep-soak bath tub, structural attic and dual-balcony setup. A perfect blend of rustic charm and modern comfort.', shortDesc: 'Charming duplex with deep-soak bath tub and dual balconies', category: 'Premium Duplex Family Suite', pricePerNight: 6500, heaterCharge: 600, capacity: 5, bedrooms: 2, bathrooms: 1, size: 556, amenities: ['wifi', 'fireplace', 'mountain view', 'coffee maker'], images: [], isActive: true, sortOrder: 4 },
