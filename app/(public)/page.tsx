...
const experiences = [
  ...
  { icon: Moon, title: 'Mountain Mornings', desc: 'Peaceful sunrise views over the Himalayas', image: 'https://images.unsplash.com/photo-1543459176-442727156fc3?w=600&q=80' },
