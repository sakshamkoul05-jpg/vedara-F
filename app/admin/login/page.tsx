        ...
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-2xl p-8 md:p-10 shadow-2xl">
          <div className="text-center mb-8">
            <Image
              ...
              width={140}
              height={50}
              className="h-auto w-auto mx-auto mb-5 logo-light"
              priority
            />
            <h1 className="font-serif text-2xl text-white">Staff Portal</h1>
            <p className="text-white/60 text-sm mt-1">Vedara Himalayan Boutique Retreat</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            {error && (
              <motion.div
                ...
                className="bg-red-500/10 border border-red-500/20 text-red-300 text-sm p-3.5 rounded-xl"
              >
                {error}
              </motion.div>
            )}
            ...
            <div>
              <label className="block text-white/70 text-xs font-medium mb-1.5 tracking-wide">Email</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="admin@vedara.com"
                  className="w-full pl-10 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 text-sm focus:outline-none focus:border-forest-400 focus:ring-1 focus:ring-forest-400/30 transition-all"
                />
              </div>
            </div>

            <div>
              <label className="block text-white/70 text-xs font-medium mb-1.5 tracking-wide">Password</label>
              <div className="relative">
                ...
                <input
                  ...
                  required
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 text-sm focus:outline-none focus:border-forest-400 focus:ring-1 focus:ring-forest-400/30 transition-all"
                />
                <button
                  type="button"
          ...
          <p className="text-center text-white/30 text-xs mt-6">
            Authorized personnel only &bull; Vedara Retreat &copy; 2026
          </p>
        </div>
      </motion.div>
    </div>
