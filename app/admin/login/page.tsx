...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen flex bg-alabaster dark:bg-[#140D07]">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          ...
          <div className="flex gap-1.5 mb-8 bg-gold-50 dark:bg-[#2E2519] rounded-xl p-1">
            {portalTabs.map((t) => {
              const Icon = t.icon;
              return (
                <button
                  ...
                  className={`flex-1 flex flex-col items-center gap-1 py-2.5 px-2 rounded-lg text-xs transition-all ${
                    portal === t.id
                      ? 'bg-white dark:bg-[#231B12] text-forest-700 shadow-sm font-medium'
                      : 'text-muted-foreground hover:text-foreground dark:text-[#B8A385]'
                  }`}
                >
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-foreground dark:text-[#F3ECDA] mb-1.5">Email</label>
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground dark:text-[#B8A385]" />
                <input
                  type="email"
                  value={email}
                  ...
                  className="w-full pl-10 pr-4 py-2.5 glass-input rounded-lg text-foreground dark:text-[#F3ECDA] placeholder-muted-foreground dark:placeholder-[#B8A385] dark:bg-[#2E2519] dark:border-white/10 text-sm focus:outline-none"
                />
              </div>
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                <label className="block text-sm font-medium text-foreground dark:text-[#F3ECDA]">Password</label>
              </div>
              <div className="relative">
                <KeyRound className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground dark:text-[#B8A385]" />
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2.5 glass-input rounded-lg text-foreground dark:text-[#F3ECDA] placeholder-muted-foreground dark:placeholder-[#B8A385] dark:bg-[#2E2519] dark:border-white/10 text-sm focus:outline-none"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground dark:text-[#B8A385] hover:text-foreground transition-colors"
                >
